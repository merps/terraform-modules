...
variable "client-child-accounts" {
  description = "List of the client / project's child AWS accounts."
  type        = "map"
}
...
variable "role-name-for-devops-cross-account-administrator-access" {
  description = "Name of the IAM role in other child AWS accounts that have the job function policy arn:aws:iam::aws:policy/AdministratorAccess"
  default     = "devops_cross_account_administrator_access"
}

variable "role-name-for-devops-cross-account-billing" {
  description = "Name of the IAM role in other child AWS accounts that have the job function policy arn:aws:iam::aws:policy/job-function/Billing"
  default     = "devops_cross_account_billing"
}

variable "role-name-for-devops-cross-account-database-administrator" {
  description = "Name of the IAM role in other child AWS accounts that have the job function policy arn:aws:iam::aws:policy/job-function/DatabaseAdministrator"
  default     = "devops_cross_account_database_administrator"
}

variable "role-name-for-devops-cross-account-data-scientist" {
  description = "Name of the IAM role in other child AWS accounts that have the job function policy arn:aws:iam::aws:policy/job-function/DataScientist"
  default     = "devops_cross_account_data_scientist"
}

variable "role-name-for-devops-cross-account-network-administrator" {
  description = "Name of the IAM role in other child AWS accounts that have the job function policy arn:aws:iam::aws:policy/job-function/NetworkAdministrator"
  default     = "devops_cross_account_network_administrator"
}

variable "role-name-for-devops-cross-account-power-user-access" {
  description = "Name of the IAM role in other child AWS accounts that have the job function policy arn:aws:iam::aws:policy/PowerUserAccess"
  default     = "devops_cross_account_power_user_access"
}

variable "role-name-for-devops-cross-account-security-audit" {
  description = "Name of the IAM role in other child AWS accounts that have the job function policy arn:aws:iam::aws:policy/SecurityAudit"
  default     = "devops_cross_account_security_audit"
}

variable "role-name-for-devops-cross-account-support-user" {
  description = "Name of the IAM role in other child AWS accounts that have the job function policy arn:aws:iam::aws:policy/job-function/SupportUser"
  default     = "devops_cross_account_support_user"
}

variable "role-name-for-devops-cross-account-system-administrator" {
  description = "Name of the IAM role in other child AWS accounts that have the job function policy arn:aws:iam::aws:policy/job-function/SystemAdministrator"
  default     = "devops_cross_account_system_administrator"
}

variable "role-name-for-devops-cross-account-view-only-access" {
  description = "Name of the IAM role in other child AWS accounts that have the job function policy arn:aws:iam::aws:policy/job-function/ViewOnlyAccess"
  default     = "devops_cross_account_view_only_access"
}

# -------------------------------------------------------------
# Default IAM role names for client's assumed roles (targets child AWS accounts)
# -------------------------------------------------------------
